...
import com.jasonmccoy.auth.util.CredentialsApiHelper;
import com.jasonmccoy.auth.util.GoogleApiClientTaskHelper;
import com.jasonmccoy.auth.util.Preconditions;
import com.jasonmccoy.auth.util.signincontainer.SmartLockBase;
...
public class AuthUI {
     ...
     * {@link com.jasonmccoy.auth.ui.idp.AuthMethodPickerActivity}
     */
    ...
    public final class SignInIntentBuilder {
        ...
        /**
         * Specifies the logo to use for the {@link com.jasonmccoy.auth.ui.idp.AuthMethodPickerActivity}. If no logo
