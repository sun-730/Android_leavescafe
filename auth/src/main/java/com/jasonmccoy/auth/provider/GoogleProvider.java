...
public class GoogleProvider implements
    ...
    public GoogleProvider(FragmentActivity activity, AuthUI.IdpConfig idpConfig) {
        this(activity, idpConfig, null);
    }

    public GoogleProvider(FragmentActivity activity, AuthUI.IdpConfig idpConfig, @Nullable String email) {
        mActivity = activity;
